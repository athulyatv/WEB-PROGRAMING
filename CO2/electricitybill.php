...
$t= "<h4> <u>BILL</u></h4><table id='bill' border='0px' width='20%' height='10%'> <tr><th
class='h'>Name</th><th class='h'>Unit</th><th class='h'>Amount</th></tr>"; 
echo "$t <tr><th>$name</th><th>$unit</th><th>$amount</th></tr>";
echo "<tr><th colspan='3' class='t'>total
}
?>
</center>
</body>
